...
@section('content')
	<div class="flex flex-col gap-10 px-5 mt-5">
		<div class="breadcrumb flex items-center gap-[30px]">
			...
			<span class="text-[#7F8190] last:text-[#0A090B]">/</span>
			<span class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Course Students</span>
		</div>
	</div>
	...
	<form action="{{ route('dashboard.courses.course_student.store', $course) }}" method="POST"
